...
class Continual_SegNet(nn.Module):
    def __init__(self, input_channels, output_channels):
        super(Continual_SegNet, self).__init__()
    ...
    def init_freezing(self):

        self.encoder_conv_00.requires_grad_(False)
        self.encoder_conv_01.requires_grad_(False)
        self.encoder_conv_10.requires_grad_(False)
        self.encoder_conv_11.requires_grad_(False)
        self.encoder_conv_20.requires_grad_(False)
        self.encoder_conv_21.requires_grad_(False)
        self.encoder_conv_22.requires_grad_(False)
        self.encoder_conv_30.requires_grad_(False)
        self.encoder_conv_31.requires_grad_(False)
        self.encoder_conv_32.requires_grad_(False)
        self.encoder_conv_40.requires_grad_(False)
        self.encoder_conv_41.requires_grad_(False)
        self.encoder_conv_42.requires_grad_(False)
